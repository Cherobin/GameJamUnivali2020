...
public class CanvasGame extends MyCanvas implements GameState {
	...
	public void render(Graphics2D dbg) {
		...
		// draw map
		// System.out.println("underroof
		// "+tileMap.isUnderRoof((int)player.position.x,(int)player.position.y));
		...
		/*
		 * //Aqui Liga e Desliga A Luz tileMap.pontosdeluz[0][0] = 1;
		 * tileMap.pontosdeluz[0][1] = Constantes.telaW/2; tileMap.pontosdeluz[0][2] =
		 * Constantes.telaH/2; tileMap.pontosdeluz[0][4] = tamanhoSensor;
